...
static NSString * const ksurvey_mobileJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_survey_mobileInjection
{
	...
	[html appendString:ksurvey_mobileJavascript];
...
{
	// attempt to make well-formed HTML and inject in our survey_mobile bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _survey_mobileInjection]];
