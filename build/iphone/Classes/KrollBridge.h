...
@interface survey_mobileObject : KrollCoverageObject {
#else
@interface survey_mobileObject : KrollObject {
#endif
@private
...
extern NSString * survey_mobile$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	survey_mobileObject *_survey_mobile;
    KrollObject* console;
	BOOL shutdown;
