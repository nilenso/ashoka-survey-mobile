...
//Rare exceptions to indicate a bug in the _survey_mobile code (Eg, function that a subclass should have implemented)
...
/**
 The base class for survey_mobile proxies.
 */
