...
// in simulator we redefine to format for survey_mobile Developer console
...
{\
	NSString * exceptionName = [@"org.survey_mobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.survey_mobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsurvey_mobileNativeItemNone = -1, 
	UIsurvey_mobileNativeItemSpinner = -2,
	UIsurvey_mobileNativeItemProgressBar = -3,
	
	UIsurvey_mobileNativeItemSlider = -4,
	UIsurvey_mobileNativeItemSwitch = -5,
	UIsurvey_mobileNativeItemMultiButton = -6,
	UIsurvey_mobileNativeItemSegmented = -7,
	
	UIsurvey_mobileNativeItemTextView = -8,
	UIsurvey_mobileNativeItemTextField = -9,
	UIsurvey_mobileNativeItemSearchBar = -10,
	
	UIsurvey_mobileNativeItemPicker = -11,
	UIsurvey_mobileNativeItemDatePicker = -12,
	
	UIsurvey_mobileNativeItemInfoLight = -13,
	UIsurvey_mobileNativeItemInfoDark = -14,
	
	UIsurvey_mobileNativeItemDisclosure = -15,
	
	UIsurvey_mobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all survey_mobile instances of
