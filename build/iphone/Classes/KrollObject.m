 ...
 * Copyright (c) 2009-2011 by survey_mobile, Inc. All Rights Reserved.
...
//@interface survey_mobileObject : NSObject
//@end

@interface survey_mobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[survey_mobileObject class]])
		{
			for (NSString *key in [[(survey_mobileObject*)o modules] allKeys])
			{
