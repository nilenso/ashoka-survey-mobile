...
/**
 Base class for all survey_mobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the survey_mobile view hierarchy (such as wrapped iOS UIViews) was touched.
