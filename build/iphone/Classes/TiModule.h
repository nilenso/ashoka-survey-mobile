...
/**
 The base class for all survey_mobile modules
 */
...
/**
 survey_mobile Platform calls this method on startup.
 */
-(void)startup;

/**
 survey_mobile Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 survey_mobile Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 survey_mobile Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 survey_mobile Platform calls this method on resume.
 @param sender The sender of the event.
 */
